...
namespace PopupShowcase.Meta.Models
{
    public class PlayerStateModel : IDisposable
    {
        ...
        private readonly RemotePlayerStateLoader _remoteLoader;
        ...
        public PlayerStateModel(
            ...
            RemotePlayerStateLoader remoteLoader)
        {
        ...
        private void ApplyPayload(PlayerStatePayload payload)
        {
        ...
        private PlayerStatePayload CreateFallbackPayload()
        {
