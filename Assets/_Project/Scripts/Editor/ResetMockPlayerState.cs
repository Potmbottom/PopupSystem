...
namespace PopupShowcase.Editor
{
    ...
    {
        private const string GameConfigPath = "Assets/_Project/Configs/GameConfig.asset";
        private const string OfferCatalogConfigPath = "Assets/_Project/Configs/OfferCatalogConfig.asset";
