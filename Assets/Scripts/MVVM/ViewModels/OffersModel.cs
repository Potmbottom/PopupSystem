...
namespace PopupShowcase.MVVM.ViewModels
{
    public interface IOffersModel
    {
        ...
        bool TryGetOffer(string offerId, out OfferModel offer);
    }
    ...
    public class OffersModel : IOffersModel, IDisposable
    {
        ...
        private readonly Dictionary<string, OfferModel> _offersById = new();
        ...
        public bool TryGetOffer(string offerId, out OfferModel offer)
        {
